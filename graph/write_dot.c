...
/*
TO USE:
mv graph/write_dot.c srcs
sudo apt-get dot -Tjpg graph.dot > graph.jpg

then call write_dot at the end of parse
like so: write_dot(&nsh->ast);

use minishell to launch a command
then convert dot file to jpg with:
